...
add_filter( 'body_class', 'justg_body_classes' );

if ( ! function_exists( 'justg_body_classes' ) ) {
	/**
	 ...
	 * @return array
	 */
	function justg_body_classes( $classes ) {
...
add_filter( 'get_custom_logo', 'justg_change_logo_class' );

if ( ! function_exists( 'justg_change_logo_class' ) ) {
	/**
	 ...
	 * @return string
	 */
	function justg_change_logo_class( $html ) {
		...
		<nav class="container navigation post-navigation block-primary">
			...
			<div class="row nav-links justify-content-between">
				...
				if ( get_next_post_link() ) {
					next_post_link( '<span class="nav-next">%link</span>', _x( '%title&nbsp;<i class="fa fa-angle-right"></i>', 'Next post link', 'justg' ) );
				}
				?>
			</div><!-- .nav-links -->
		</nav><!-- .navigation -->
...
if ( ! function_exists( 'justg_pingback' ) ) {
	/**
	 * Add a pingback url auto-discovery header for single posts of any post type.
	 */
	function justg_pingback() {
		if ( is_singular() && pings_open() ) {
			echo '<link rel="pingback" href="' . esc_url( get_bloginfo( 'pingback_url' ) ) . '">' . "\n";
		}
	}
}
add_action( 'wp_head', 'justg_pingback' );

if ( ! function_exists( 'justg_mobile_web_app_meta' ) ) {
	/**
	 * Add mobile-web-app meta.
	 */
	function justg_mobile_web_app_meta() {
		echo '<meta name="mobile-web-app-capable" content="yes">' . "\n";
		echo '<meta name="apple-mobile-web-app-capable" content="yes">' . "\n";
		echo '<meta name="apple-mobile-web-app-title" content="' . esc_attr( get_bloginfo( 'name' ) ) . ' - ' . esc_attr( get_bloginfo( 'description' ) ) . '">' . "\n";
	}
}
add_action( 'wp_head', 'justg_mobile_web_app_meta' );

if ( ! function_exists( 'justg_default_body_attributes' ) ) {
	/**
	 ...
	 * @return array
	 */
	function justg_default_body_attributes( $atts ) {
		$atts['itemscope'] = '';
		$atts['itemtype']  = 'http://schema.org/WebSite';
		return $atts;
	}
}
add_filter( 'justg_body_attributes', 'justg_default_body_attributes' );

// Escapes all occurances of 'the_archive_description'.
add_filter( 'get_the_archive_description', 'justg_escape_the_archive_description' );

if ( ! function_exists( 'justg_escape_the_archive_description' ) ) {
	/**
...
add_filter( 'the_title', 'justg_kses_title' );

// Escapes all occurances of 'the_archive_title' and 'get_the_archive_title()'.
add_filter( 'get_the_archive_title', 'justg_kses_title' );

if ( ! function_exists( 'justg_kses_title' ) ) {
	/**
	 ...
	 */
	function justg_kses_title( $data ) {
		...
		$allowed_tags = apply_filters( 'justg_kses_title', $allowed_tags );

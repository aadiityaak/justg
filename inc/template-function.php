    ...
    function justg_widget_float() {
        ...
        if($no_wa){
            echo '<div class="float-widget">';
                ...
                if($to_top_status == 'on') {
                    echo '<a id="go-to-top" class="position-fixed btn bg-to_top-float whatsapp-float text-white" style="right:10px;"><span class="dashicons dashicons-'.esc_attr( $icon_to_top ).'"></span></a>';
                }
                echo '</div>';
        }
    }

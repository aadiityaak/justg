...
<div class="shopping-cart-widget-body justg-scroll">
	<div class="justg-scroll-content">
				...
				<?php
					...
					foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
						...
						if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_widget_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
							...
							?>
							<li class="woocommerce-mini-cart-item <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>" data-key="<?php echo esc_attr( $cart_item_key ); ?>">								<?php
			...
			<?php if ( wc_get_page_id( 'shop' ) > 0 ) : ?>
				<p class="return-to-shop">
					<a class="button wc-backward" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>">
						<?php esc_html_e( 'Return To Shop', 'justg' ) ?>
					</a>
				</p>
			<?php endif; ?>
...
<div class="shopping-cart-widget-footer<?php echo ( WC()->cart->is_empty() ? ' justg-cart-empty' : '' ); ?>">
	<?php if ( ! WC()->cart->is_empty() ) : ?>
